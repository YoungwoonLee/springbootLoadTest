package com.chandler.loadtest.testrunnet;
...
public class ZeroCodeSpringbootJUnit4Runner extends SpringJUnit4ClassRunner {


    private static final Logger LOGGER = LoggerFactory.getLogger(ZeroCodeSpringbootJUnit4Runner.class);
    ...
    public ZeroCodeSpringbootJUnit4Runner(Class<?> clazz) throws InitializationError {
        super(clazz);
